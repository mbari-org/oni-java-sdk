...
public class PageSeqReference implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private java.util.List<Reference> content;
    /**
     * The limit property
     */
    ...
    /**
     * Instantiates a new {@link PageSeqReference} and sets the default values.
     */
    public PageSeqReference() {
    ...
    public static PageSeqReference createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new PageSeqReference();
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("content", (n) -> { this.setContent(n.getCollectionOfObjectValues(Reference::createFromDiscriminatorValue)); });
     ...
     */
    public void setContent(@jakarta.annotation.Nullable final java.util.List<Reference> value) {
        this.content = value;
    }
    /**
