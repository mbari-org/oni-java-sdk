...
public class PageSeqExtendedHistory implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private java.util.List<ExtendedHistory> content;
    /**
     * The limit property
     */
    ...
    /**
     * Instantiates a new {@link PageSeqExtendedHistory} and sets the default values.
     */
    public PageSeqExtendedHistory() {
    ...
    public static PageSeqExtendedHistory createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new PageSeqExtendedHistory();
    }
    /**
    ...
    public java.util.List<ExtendedHistory> getContent() {
        return this.content;
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("content", (n) -> { this.setContent(n.getCollectionOfObjectValues(ExtendedHistory::createFromDiscriminatorValue)); });
     ...
     */
    public void setContent(@jakarta.annotation.Nullable final java.util.List<ExtendedHistory> value) {
        this.content = value;
    }
    /**
