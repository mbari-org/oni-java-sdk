...
public class ExtendedLink implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link ExtendedLink} and sets the default values.
     */
    public ExtendedLink() {
    ...
    public static ExtendedLink createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
