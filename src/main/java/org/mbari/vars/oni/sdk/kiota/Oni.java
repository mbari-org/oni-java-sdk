package org.mbari.vars.oni.sdk.kiota;
...
import org.mbari.vars.oni.sdk.kiota.v1.V1RequestBuilder;
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
@jakarta.annotation.Generated("com.microsoft.kiota")
public class Oni extends BaseRequestBuilder {
    /**
     * The v1 property
    ...
    /**
     * Instantiates a new {@link Oni} and sets the default values.
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public Oni(@jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
