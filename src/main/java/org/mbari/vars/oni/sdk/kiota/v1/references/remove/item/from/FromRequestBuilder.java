package org.mbari.vars.oni.sdk.kiota.v1.references.remove.item.from;
...
import org.mbari.vars.oni.sdk.kiota.v1.references.remove.item.from.item.WithConceptItemRequestBuilder;
/**
 * Builds and executes requests for operations under /v1/references/remove/{id}/from
 */
@jakarta.annotation.Generated("com.microsoft.kiota")
public class FromRequestBuilder extends BaseRequestBuilder {
    /**
     * Gets an item from the org.mbari.vars.oni.sdk.kiota.v1.references.remove.item.from.item collection
    ...
    public FromRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/v1/references/remove/{id}/from", pathParameters);
    }
    /**
     * Instantiates a new {@link FromRequestBuilder} and sets the default values.
    ...
    public FromRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/v1/references/remove/{id}/from", rawUrl);
    }
}
