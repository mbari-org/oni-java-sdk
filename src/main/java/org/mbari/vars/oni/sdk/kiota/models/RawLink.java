...
public class RawLink implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link RawLink} and sets the default values.
     */
    public RawLink() {
     ...
     * @return a {@link RawLink}
     */
    @jakarta.annotation.Nonnull
    public static RawLink createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
