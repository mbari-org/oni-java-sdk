package org.mbari.vars.oni.sdk.kiota.v1.references.query.citation;
...
/**
 * Builds and executes requests for operations under /v1/references/query/citation
 */
...
public class CitationRequestBuilder extends BaseRequestBuilder {
    ...
    public CitationRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/v1/references/query/citation{?limit*,offset*}", pathParameters);
    }
    /**
     * Instantiates a new {@link CitationRequestBuilder} and sets the default values.
    ...
    public CitationRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/v1/references/query/citation{?limit*,offset*}", rawUrl);
    }
    /**
    ...
    public PageSeqReference post(@jakarta.annotation.Nonnull final ReferenceQuery body) {
     ...
     */
    @jakarta.annotation.Nullable
    public PageSeqReference post(@jakarta.annotation.Nonnull final ReferenceQuery body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
