...
public class MediaUpdate implements AdditionalDataHolder, Parsable {
    /**
    ...
    private String url;
    /**
     * Instantiates a new {@link MediaUpdate} and sets the default values.
     */
    public MediaUpdate() {
     ...
     * @return a {@link MediaUpdate}
     */
    @jakarta.annotation.Nonnull
    public static MediaUpdate createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
