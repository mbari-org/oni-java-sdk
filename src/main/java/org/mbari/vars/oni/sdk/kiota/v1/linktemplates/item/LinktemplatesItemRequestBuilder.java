package org.mbari.vars.oni.sdk.kiota.v1.linktemplates.item;
...
/**
 * Builds and executes requests for operations under /v1/linktemplates/{id}
 */
@jakarta.annotation.Generated("com.microsoft.kiota")
public class LinktemplatesItemRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link LinktemplatesItemRequestBuilder} and sets the default values.
     * @param pathParameters Path parameters for the request
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public LinktemplatesItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/v1/linktemplates/{id}", pathParameters);
    }
    /**
     * Instantiates a new {@link LinktemplatesItemRequestBuilder} and sets the default values.
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public LinktemplatesItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/v1/linktemplates/{id}", rawUrl);
    }
    /**
     * Delete a link template
     * @return a {@link LinktemplatesDeleteResponse}
    ...
    public LinktemplatesDeleteResponse delete() {
        return delete(null);
    }
    /**
     * Delete a link template
     ...
     */
    @jakarta.annotation.Nullable
    public LinktemplatesDeleteResponse delete(@jakarta.annotation.Nullable final java.util.function.Consumer<DeleteRequestConfiguration> requestConfiguration) {
        ...
        return this.requestAdapter.send(requestInfo, errorMapping, LinktemplatesDeleteResponse::createFromDiscriminatorValue);
    }
    /**
     ...
     */
    @jakarta.annotation.Nonnull
    public LinktemplatesItemRequestBuilder withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
        Objects.requireNonNull(rawUrl);
        return new LinktemplatesItemRequestBuilder(rawUrl, requestAdapter);
    }
    /**
