package org.mbari.vars.oni.sdk.kiota.v1.reference.add.item.to;

import com.microsoft.kiota.BaseRequestBuilder;
import com.microsoft.kiota.RequestAdapter;
import java.util.HashMap;
import java.util.Objects;
import org.mbari.vars.oni.sdk.kiota.v1.reference.add.item.to.item.WithConceptItemRequestBuilder;
/**
 * Builds and executes requests for operations under /v1/reference/add/{id}/to
 */
@jakarta.annotation.Generated("com.microsoft.kiota")
public class ToRequestBuilder extends BaseRequestBuilder {
    /**
     * Gets an item from the org.mbari.vars.oni.sdk.kiota.v1.reference.add.item.to.item collection
    ...
    public ToRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/v1/reference/add/{id}/to", pathParameters);
    }
    /**
     * Instantiates a new {@link ToRequestBuilder} and sets the default values.
    ...
    public ToRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/v1/reference/add/{id}/to", rawUrl);
    }
}
